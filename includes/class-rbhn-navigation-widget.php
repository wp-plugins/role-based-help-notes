...
class RBHN_Contents_Page_Navigation_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__('Help Note Contents Page Navigation', 'role-based-help-notes-text-domain'), // Name
			array( 'description' => __( 'Add contents page naviation button to sidebar', 'role-based-help-notes-text-domain' ), ) // Args
		);
	}
